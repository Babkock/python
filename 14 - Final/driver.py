...
if __name__ == "__main__":
    ...
    add = tkinter.Button(bottom_frame, text=' + ', bd=0, width=2, height=2, fg="#561410", bg="#bd5054", activeforeground="#571b18", activebackground="#c35b58", font=("Ubuntu Mono", 22), command=plus).grid(row=2, column=4)
    ...
    subtract = tkinter.Button(bottom_frame, text=' - ', bd=0, width=2, height=2, fg="#561410", bg="#bd5054", activeforeground="#571b18", activebackground="#c35b58", font=("Ubuntu Mono", 22), command=minus).grid(row=3, column=4)
    ...
    equals = tkinter.Button(bottom_frame, text=' = ', bd=0, width=2, height=2, fg="#204450", bg="#30adb8", activeforeground="#224b57", activebackground="#38b5c1", font=("Ubuntu Mono", 22), command=press_equals).grid(row=5, column=3)
